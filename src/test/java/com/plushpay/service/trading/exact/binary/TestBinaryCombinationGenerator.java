package com.plushpay.service.trading.exact.binary;

import com.plushpay.service.trading.exact.CombinationGenerator;
 ...
 */
class TestBinaryCombinationGenerator {
    ...
    void viewOutput() {
        ...
        for (int i = 0; i < numIterations; i++) {
            now = System.nanoTime();
            BinaryCombinationGenerator<Character> cg = new BinaryCombinationGenerator<Character>(
                set, set.size());
    ...
    public void compareExecutionTime() {
        ...
        List<Character> set = Arrays.asList('A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K',
            'L', 'M');
        List<List<Character>> test1 = new ArrayList<List<Character>>();
        List<List<Character>> test2 = new ArrayList<List<Character>>();
