 ...
 */
public class Trade implements IdEntity<Long> {
    ...
    public Trade(TraderGroup buyerGroup, TraderGroup sellerGroup,
        Calendar dateCreated, TradeStatus status) {
     ...
     * <p>
     * This is used with SellerBuy Mismatch to compute the value lost in trade from the Buyer.buy
     * currency type buffer due to exchange rate variances.
     *
     * @return
     */
     ...
     * <p>
     * This is used with BuyerBuy Mismatch to compute the value lost in trade from the Seller.sell
     * currency type buffer due to exchange rate variances.
     *
     * @return
     */
