...
/**
 * This is the base concept for trading.  Every currency is converted to a baseRate 			upon
 * creation.  This base rate is used for all computation and comparison 			as this allows cross
 * currency comparison and inter-currency comparison  			even when multiple exchange rates are
 * used.
 */
public class PyCurrency implements Comparable, IdEntity<Long> {
    ...
    public String toString() {
        ...
        buffer.append("currencyId").append("='").append(getId())
            .append("'\n");
    ...
    public PyCurrency(PyCurrency original) {
        ...
        this.currencyId = original.getId();
    ...
    /**
     * Compare to method. Return 0 if they are same Return 1 if this is > Return -1 if this is <
     */
