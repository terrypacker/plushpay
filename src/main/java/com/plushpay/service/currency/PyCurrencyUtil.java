...
public class PyCurrencyUtil {
    ...
    /**
     * Convert Currency toTypeAmount/toTypeRate = fromTypeAmount/fromTypeRate
     * <p>
    ...
    /**
     * Create a new currency that is rounded to the cents value. (Making the 2 extra places used in
     * the system = 00)
     *
     * @param currency
     * @return
