...
public class NaiFileTrailer extends Bai2Record {
	...
	private long fileTotalA; //	The sum of the Group control totals A in all  Group Trailer (record type 98) records in this file.
	private int numberOfGroups; //	The number of groups in this file. That is, the number of Group header (record type 02) records in this file.
	...
	private long fileTotalB; //	The sum of the Group control totals B in all Group Trailer (record type 98) records in this file.
