...
public class NaiAccountTrailer extends Bai2Record {
	...
	private long accountTotalB; //	The sum of all amount fields in record types 03
								 //(excluding the amounts for account summary codes 965,966,967,968,969), 16 and 88 for the account.
