package com.plushpay.service.banking.au.nab.nai.records;

import com.plushpay.service.banking.bai2.codes.Bai2RecordCode;
import com.plushpay.service.banking.bai2.records.Bai2Record;

public class NaiGroupTrailer extends Bai2Record {

	private long groupTotalA; //	The sum of the Account control totals A in all Account trailer (record type 49) records in this group.
	private int numberOfAccounts; //	The number of accounts in this group. That is the number of Account identifier and summary status (record type 03) records in this group.
	private long groupTotalB; //	The sum of the Account control totals B in all Account trailer (record type 49) records in this group
