...
public class Creature implements Comparable<Creature> {
    ...
    public void computeFitnessCriteria() {
        ...
        for (int i = 0; i < this.buyers.size(); i++) {
            ...
            valueSum =
                valueSum + this.buyers.get(i).getCurrencyToSell().getValue() * this.buyers.get(i)
        ...
        for (int i = 0; i < this.sellers.size(); i++) {
            ...
            valueSum =
                valueSum + this.sellers.get(i).getCurrencyToBuy().getValue() * this.sellers.get(i)
    ...
    public List<Creature> breedByBest(Creature creature) throws Exception {
        ...
        if (this.buyers.size() > 4) {
            ...
            for (int i = 0; i < this.buyers.size(); i++) {
                ...
                if ((temp.getCurrencyToSell().getValue() - temp.getCurrencyToBuy().getValue())
                    > 0) {
    ...
    /**
     * Return 2 lists of sellers one for each child
     *
     * @return
     */
