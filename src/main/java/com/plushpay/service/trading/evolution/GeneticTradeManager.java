...
public class GeneticTradeManager extends Thread {
    ...
    public void run() {
        ...
        while (!this.shutdown) {
            ...
            if (best != null) {
                ...
                this.log.debug(
                    "Creating Trade: Buyer Profit " + best.getBuyerProfit() + " Seller Profit "
                        + best.getSellerProfit());
    ...
    private void writeStats(Creature best) throws IOException {
        ...
        if (this.writeToFile) {
            String data =
                this.apocalypse + "," + best.getBuyerProfit() + "," + best.getSellerProfit() + "," +
                    +best.getBuyers().size() + "," +
    ...
    private Creature foundTrade() {
        ...
        this.log.info(
            "Interval (" + this.apocalypse + ") took " + ((float) this.lastEvolutionTime * .000001f)
                + "ms :" + " Best Fitness: " + best.getFitness() + " Best Buyer Profit: "
                + best.getBuyerProfit() +
