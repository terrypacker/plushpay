...
public class TradeProfitNode implements Comparable<TradeProfitNode> {
    ...
    public TradeProfitNode(TraderGroupUtil buyers, TraderGroupUtil sellers) {
        ...
        long buyerBuy =
            this.sellers.getCurrencyToSell().getValue() - this.buyers.getCurrencyToBuy().getValue();
        long buyerSell =
            this.buyers.getCurrencyToSell().getValue() - this.sellers.getCurrencyToBuy().getValue();
     ...
     * <p>
     * Return 1 if > than Return -1 if less than Return 0 if equal
     */
