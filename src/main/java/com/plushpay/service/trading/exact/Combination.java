...
public class Combination implements Comparable<Combination> {
    ...
    /**
     * Create a combination and compute values for this group of buyers and sellers
     *
     * @param buyers
     * @param sellers
     * @throws Exception
    ...
    public Combination(List<Trader> buyers, List<Trader> sellers) throws Exception {
        ...
        valueSum = valueSum + buyers.get(0).getCurrencyToSell().getValue() * buyers.get(0)
            .getCurrencyToSell().getType().getRateToBase();
        ...
        for (int i = 1; i < this.buyers.size(); i++) {
            ...
            valueSum = valueSum + buyers.get(i).getCurrencyToSell().getValue() * buyers.get(i)
                .getCurrencyToSell().getType().getRateToBase();
        ...
        valueSum = valueSum + sellers.get(0).getCurrencyToBuy().getValue() * sellers.get(0)
            .getCurrencyToBuy().getType().getRateToBase();
        ...
        for (int i = 1; i < this.sellers.size(); i++) {
            ...
            valueSum = valueSum + sellers.get(i).getCurrencyToBuy().getValue() * sellers.get(i)
                .getCurrencyToBuy().getType().getRateToBase();
        ...
        this.sellerProfit =
            this.sellersCurrencyToSell.getValue() - this.buyersCurrencyToBuy.getValue();
        this.buyerProfit =
            this.buyersCurrencyToSell.getValue() - this.sellersCurrencyToBuy.getValue();
    ...
    /**
     * Generate a Combination by sorting traders into buyers and sellers
     *
     * @param list
     * @throws Exception
     */
    public Combination(List<Trader> traders) throws Exception {
        ...
        for (int i = 0; i < traders.size(); i++) {
            ...
            if (traders.get(i).getCurrencyToBuy().getType().getCode()
                .equals(CurrencyCodeEnum.USD)) {
                ...
                if (this.buyersCurrencyToBuy == null) {
                    ...
                    this.buyersCurrencyToBuy = this.buyersCurrencyToBuy.add(
                        traders.get(i).getCurrencyToBuy());
                }

                if (this.buyersCurrencyToSell == null) {
                    this.buyersCurrencyToSell = traders.get(i).getCurrencyToSell();
                } else {
                    this.buyersCurrencyToSell = this.buyersCurrencyToSell.add(
                        traders.get(i).getCurrencyToSell());
                }

                valueSum = valueSum + traders.get(i).getCurrencyToSell().getValue() * traders.get(i)
                    .getCurrencyToSell().getType().getRateToBase();
                ...
                if (this.sellersCurrencyToBuy == null) {
                    ...
                    this.sellersCurrencyToBuy = this.sellersCurrencyToBuy.add(
                        traders.get(i).getCurrencyToBuy());
                }
                ...
                if (this.sellersCurrencyToSell == null) {
                    ...
                    this.sellersCurrencyToSell = this.sellersCurrencyToSell.add(
                        traders.get(i).getCurrencyToSell());
                }

                valueSum = valueSum + traders.get(i).getCurrencyToBuy().getValue() * traders.get(i)
                    .getCurrencyToBuy().getType().getRateToBase();
