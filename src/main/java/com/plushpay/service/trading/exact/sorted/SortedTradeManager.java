...
public class SortedTradeManager extends Thread {
    ...
    public SortedTradeManager(TradeService tradeService, TraderService traderService) {
        super("Sorted Trade Manager");
    ...
    private List<Trader> getNewBuyers() {
        //Load in all free buyers of this currency Type and lock them
