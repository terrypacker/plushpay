 ...
 * @see com.payyourself.accounting.transaction.Transaction
	...
	public Transaction findById(long id) {
		...
		try {
			Transaction instance = (Transaction) sessionFactory
					.getCurrentSession()
					.get("com.payyourself.accounting.transaction.Transaction",
							id);
			if (instance == null) {
	...
	public List<Transaction> findByExample(Transaction instance) {
		...
		try {
			List<Transaction> results = (List<Transaction>) sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.payyourself.accounting.transaction.Transaction")
