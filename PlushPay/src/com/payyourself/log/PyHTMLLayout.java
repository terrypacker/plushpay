 ...
 * Licensed to the Apache Software Foundation (ASF) under one or more
      Ê  * contributor license agreements.  See the NOTICE file distributed with
      Ê  * this work for additional information regarding copyright ownership.
      Ê  * The ASF licenses this file to You under the Apache License, Version  . 
      Ê  * (the "License"); you may not use this file except in compliance with
      Ê  * the License.  You may obtain a copy of the License at
      Ê  * 
 ...
 * 
 * Appenders using this layout should have their encoding set to UTF- or UTF-16,
 * otherwise events containing non ASCII characters could result in corrupted
 * log files.
 * 
 * @author Ceki G&uuml;lc&uuml;
 */
public class PyHTMLLayout extends Layout {
	...
	public String format(LoggingEvent event) {
		...
		time.setTimeInMillis(event.timeStamp);
		SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
		
		sbuf.append(sdf.format(time.getTime()));
	...
	public String getHeader() {
		...
		sbuf
				.append("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4. Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">"
						+ Layout.LINE_SEP);
