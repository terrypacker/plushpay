 ...
 * @see com.payyourself.accounting.period.Period
...
public class PeriodHome {
	...
	public Period findById(int id) {
		...
		try {
			Period instance = (Period) sessionFactory.getCurrentSession().get(
					"com.payyourself.accounting.period.Period", id);
			if (instance == null) {
	...
	public List<Period> findByExample(Period instance) {
		log.debug("finding Period instance by example");
		try {
			List<Period> results = (List<Period>) sessionFactory
					.getCurrentSession().createCriteria(
							"com.payyourself.accounting.period.Period").add(
