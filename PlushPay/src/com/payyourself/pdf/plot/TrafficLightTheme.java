 ...
 * @since 1.0.11
 */
public class TrafficLightTheme implements ChartTheme, Cloneable,
        PublicCloneable, Serializable {

    /**
	 * 
	 */
	private static final long serialVersionUID = 6421126022964819876L;
    ...
    public static ChartTheme createJFreeTheme() {
        return new TrafficLightTheme("JFree");
    }
    ...
    public static ChartTheme createDarknessTheme() {
        TrafficLightTheme theme = new TrafficLightTheme("Darkness");
    ...
    public static ChartTheme createLegacyTheme() {
        TrafficLightTheme theme = new TrafficLightTheme("Legacy") {
            /**
			 * 
			 */
     ...
     */
    public TrafficLightTheme(String name) {
        if (name == null) {
            throw new IllegalArgumentException("Null 'name' argument.");
        }
        this.name = name;
        this.extraLargeFont = new Font("Tahoma", Font.BOLD, 10);
        this.largeFont = new Font("Tahoma", Font.BOLD, 10);
        this.regularFont = new Font("Tahoma", Font.PLAIN, 8);
     ...
     * @param bgColor
     */
    public TrafficLightTheme(String name, Color bgColor) {
        if (name == null) {
            throw new IllegalArgumentException("Null 'name' argument.");
        }
        this.name = name;
        ...
        this.legendBackgroundPaint = Color.white;
        this.legendItemPaint = Color.darkGray;
        this.chartBackgroundPaint = bgColor;//Color.white;
        this.drawingSupplier = new DefaultDrawingSupplier();
        this.plotBackgroundPaint = Color.lightGray;
        this.plotOutlinePaint = Color.black;
        this.labelLinkPaint = Color.black;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TrafficLightTheme)) {
            return false;
        }
        TrafficLightTheme that = (TrafficLightTheme) obj;
